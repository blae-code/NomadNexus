...
export const NomadShell = () => {
  ...
  const { connect, room, connectionState, error: liveKitError } = useLiveKit();
  ...
  }, [token, serverUrl, participantName, connectionState, connect, roomName, profile?.rank, profile?.id]);
  ...
  return (
    ...
    >
      <RoomAudioRenderer className="hidden" />
